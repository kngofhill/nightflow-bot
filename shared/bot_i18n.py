...
LANG_ONLY = "🌙 Nightflow is <b>English only</b>. Open the mini app from the ⋮ menu or the 📱 Mini App button."
...
def welcome_back(name: str, _code: str) -> str:
    n = name or "there"
    return f"👋 {n}, back. Tap <b>Menu</b> on the next message · /start"


# First /start (HTML) — minimal
INTRO: str = (
    "✨ <b>App</b> (⋮ menu): <b>Home</b> · <b>Plan</b> · <b>Week</b> · <b>Ideas</b> · <b>Settings</b> — Pro features need Pro.\n"
    "<b>Bot</b>: inline buttons on the next message, or /subscribe /cancel /pause /resume."
)
